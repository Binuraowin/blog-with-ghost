  ...
  return (
    ...
    <footer className="px-2 sm:px-4 py-2.5 dark:bg-gray-900 w-full">
      ...
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        ...
        <Link href="https://github.com/Binuraowin" className="flex items-center">
          <span className="self-center text-gray-800 text-sm font-semibold whitespace-nowrap dark:text-white">2023 copyright Binura Owin</span>
        </Link>
